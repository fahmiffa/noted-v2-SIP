    ...
    <div class="container">
        <div class="card card-body">
            <div class="col-12">               
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-6">
                            <div class="card text-center border border-dark fw-bold">
                                ...
                                <div class="card-body" >
                                    @if($member->barp)
                                    <img src="{{$member->barp}}" class="mx-auto d-block img-fluid">
                                    @endif
                                </div>
                                <div class="card-footer">
                                    <button class="btn btn-primary btn-sm rounded-pill mx-auto d-block signs" data-id="{{md5($member->user)}}" type="button">Tanda Tangan</button>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="row">
                    @if($doc == 'bak')
                        <div class="col-6 col-sm-6">
                            <div class="card text-center border border-dark fw-bold">
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-primary btn-sm rounded-pill mx-auto d-block signs" data-id="pemohon" type="button">Tanda Tangan</button>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if($news->primary == 'TPA' && $lead)
                            ...
                            <div class="card text-center border border-dark fw-bold">
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-primary btn-sm rounded-pill mx-auto d-block signs" data-id="petugas" type="button">Tanda Tangan</button>
                                </div>
                            </div>                                           
                        </div>                            
                    @endif
                ...
                @if($lead)
                <form action="{{ $doc == 'bak' ? route('pub.bak', ['id' => md5($news->id)]) : route('pub.barp', ['id' => md5($news->id)]) }}" method="post">
                    @csrf        
        ...
        <div class="modal fade" id="signatureModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <form action="{{ $doc == 'bak' ? route('signed.news',['id'=>md5($news->id)]) : route('signed.meet',['id'=>md5($news->id)]) }}" id="sign" method="post">    
                        @csrf
                        <canvas id="signatureCanvas" class="border border-light mx-auto d-block mb-3" width="450" height="200"></canvas>
                        <button type="button" id="clear" class="btn btn-dark btn-sm my-3 rounded-pill">Clear</button>                          
