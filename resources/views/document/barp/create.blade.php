                    ...
                    <form action="{{ route('meet.store') }}" method="post" id="publish">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 my-3">
                                <div class="form-check mb-3">
                                    ...
                                    <input type="checkbox" class="form-check-input form-check-primary form-check-glow"
                                        name="val0" {{ isset($meet) && $val[0] == 1 ? 'checked' : $default }}>
                            ...
                            <div class="col-md-12">
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input form-check-primary form-check-glow"
                                        name="val1" {{ isset($meet) && $val[1] == 1 ? 'checked' : $default }}>
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input form-check-primary form-check-glow"
                                        name="val2" {{ isset($meet) && $val[2] == 1 ? 'checked' : $default }}>
                                ...
                                <div class="form-check mb-3">
                                    <input type="checkbox" class="form-check-input form-check-primary form-check-glow"
                                        name="val3" {{ isset($meet) && $val[3] == 1 ? 'checked' : $default }}>
