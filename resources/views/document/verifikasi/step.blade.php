                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-5">
                            <div class="form-group d-flex justify-content-center">
                                <div class="form-check d-inline-block">
                                    <input class="form-check-input" type="radio"
                                        name="itemDpl[{{ $item->id }}]" value="1"
                                        {{ $remain && $itemDpl[$item->id] == 1 ? 'checked' : null }}>
                                    <label class="form-check-label">Ada</label>
                                </div>
                                <div class="form-check d-inline-block mx-3">
                                    <input class="form-check-input" type="radio"
                                ...
                                <div class="form-check d-inline-block">
                                    @if ($remain)
                                        <input class="form-check-input" type="radio"
                                            name="itemDpl[{{ $item->id }}]" value="2"
                                            {{ $remain && $itemDpl[$item->id] == 2 ? 'checked' : null }}>
                                    @else
                                        <input class="form-check-input" type="radio"
                                            name="itemDpl[{{ $item->id }}]" value="2" checked>
                                    @endif
                                    <label class="form-check-label">Tidak Perlu</label>
                                </div>
                            </div>
...
@endif
<label>Saran : </label>
<textarea class="form-control summernote" name="content" rows="2">{!! isset($remain) ? $head->saran : null !!}</textarea>
