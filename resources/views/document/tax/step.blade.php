                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="hidden" value="{{ $tax ? $tax->ip[0] : 0 }}" name="ip[]"
                                            id="name-ip">
                                        <select class="form-control select-field w-100" onchange="pilihNilaine(this)"
                                            name="ip[]" id="ip">
                                            @if ($tax)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" value="{{ $tax ? $tax->ip[2] : 0 }}" name="ip[]"
                                            id="index-ip">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="hidden" value="{{ $tax ? $tax->il[0] : 0 }}" name="il[]"
                                            id="name-il">
                                        <select class="form-control select-field w-100" onchange="pilihNilaine(this)"
                                            name="il[]" id="il">
                                            @if ($tax)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" value="{{ $tax ? $tax->il[2] : 0 }}" name="il[]"
                                            id="index-il">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="hidden" value="{{ $tax ? $tax->fm[0] : 0 }}" name="fm[]"
                                            id="name-fm">
                                        <select class="form-control select-field w-100" onchange="pilihNilaine(this)"
                                            name="fm[]" id="fm">
                                            @if ($tax)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" value="{{ $tax ? $tax->fm[2] : 0 }}" name="fm[]"
                                            id="index-fm">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="text" value="{{ $tax ? $tax->it : 0 }}" class="form-control"
                                            name="it" id="it" readonly>
                                    </td>
                                    <td class="text-center">
                                        <p id="view-it"></p>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="hidden" value="{{ $tax ? $tax->ibg[0] : 0 }}" name="ibg[]"
                                            id="name-ibg">
                                        <select class="form-control select-field w-100" onchange="pilihNilaine(this)"
                                            name="ibg[]" id="ibg">
                                            @if ($tax)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <input type="hidden" value="{{ $tax ? $tax->ibg[2] : 0 }}" name="ibg[]"
                                            id="index-ibg">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%">
                                        <input type="number" value="{{ $tax ? $tax->ilo : 0 }}" name="ilo"
                                            class="form-control w-75" id="ilo" readonly>
                                    </td>
                                    <td class="text-center">
                            ...
                            <tbody>
                                @for ($i = 1; $i < 11; $i++)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>
                                            <input type="text" class="form-control" name="par[{{ $i }}][]"
                                                value="{{ $tax ? $par[$i][0] : null }}">
                                        </td>
                                        <td>
                                            <input type="number" value="{{ $tax ? $par[$i][1] : 0 }}"
                                                onkeyup="sumWide()" class="form-control float-input"
                                                name="par[{{ $i }}][]">
                                        </td>
                                    </tr>
                                @endfor
                                <tr class="text-end">
                                    ...
                                    <td><input type="number" id="llt" name="llt"
                                            value="{{ $tax ? $tax->llt : null }}" class="form-control" readonly></td>
                                </tr>
                                <tr class="text-end">
                                    <td colspan="2">
                                    ...
                                    <td class="text-end">
                                        <p id="view-retri" class="my-auto">
                                            {{ $tax ? number_format($tax->retri, 0, ',', '.') : null }}</p>
                                        <input type="hidden" id="retri" name="retri"
                                            value="{{ $tax ? $tax->retri : null }}" class="form-control">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @for ($i = 1; $i < 11; $i++)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" onkeyup="praSum(this)" data-id="{{ $i }}"
                                                class="form-control vol" value="{{ $tax ? $pra[$i][1] : 0 }}"
                                                name="pra[{{ $i }}][]">
                                        </td>
                                        <td>
                                            <p class="text-center my-auto" id="view-sat{{ $i }}">
                                                {{ $tax ? $pra[$i][2] : null }}</p>
                                            <input type="hidden" class="form-control" id="sat{{ $i }}"
                                                value="{{ $tax ? $pra[$i][2] : null }}"
                                                name="pra[{{ $i }}][]">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" value="{{ $tax ? $pra[$i][4] : 0 }}"
                                                class="form-control sum" id="sum{{ $i }}"
                                                name="pra[{{ $i }}][]" readonly>
                                        </td>
                                    </tr>
                                @endfor
                                <tr class="text-end">
                                    ...
                                    <td>
                                        <p id="view-sumPra" class="my-auto text-end">
                                            {{ $tax ? number_format($tax->sumPra, 0, ',', '.') : 0 }}</p>
                                        <input type="hidden" name="sumPra" id="sumPra"
                                            value="{{ $tax ? $tax->sumPra : 0 }}" class="form-control" readonly>
                                    </td>
                                </tr>
                                <tr class="text-end">
                                    <td colspan="5">
                                    ...
                                    <td>
                                        <p id="view-totRetri" class="my-auto text-end">
                                            {{ $tax ? number_format($tax->totRetri, 0, ',', '.') : 0 }}</p>
                                        <input type="hidden" name="totRetri" id="totRetri"
                                            value="{{ $tax ? $tax->totRetri : 0 }}" class="form-control" readonly>
                                    </td>
                                </tr>
                            </tbody>
